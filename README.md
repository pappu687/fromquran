...
If you want this README to become even more useful later, the next additions should be:

- environment variables reference
- Solr setup/indexing instructions
- sample contributor accounts / seeded roles
- deployment notes
- architecture notes for resource ingestion/import pipelines
