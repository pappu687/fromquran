...
Route::prefix('quran')->group(function () {
    ...
    Route::get('/audio/verse/{chapterId}/{verseNumber}', [QuranVerseAudioController::class, 'verseAudio']);
    ...
    Route::get('/verses/{chapterId}/{verseNumber}/navigation', [QuranVerseAudioController::class, 'navigation']);
...
Route::prefix('qf')->group(function () {
    ...
    Route::get('/answers/by-ayah/{chapterId}/{verseNumber}', [QuranFoundationController::class, 'ayahAnswers'])
        ->whereNumber(['chapterId', 'verseNumber']);
});
